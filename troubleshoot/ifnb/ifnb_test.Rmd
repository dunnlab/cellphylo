...
IntegrateData settings used above and in my workflow are the defaults for:
sample.tree = NULL  
preserve.order=FALSE  

In output saw:
-Same order of merging
-Different number of anchors found by FindIntegrationAnchors

#CTRL_first
Found 16393 anchors
Merging data set 1 into 2

#STIM_first
Found 16390 anchors
Merging data set 2 into 1
