...
wrangled_mat <- wrangle_matrix(path_to_mat = "matrix/10x/aqhumor_UMI_mouse", metadata_file = "ann/all_five_species_metafile_wrangled.csv" , species = "mouse")
wrangled_mat <- wrangle_matrix(path_to_mat = "matrix/10x/aqhumor_UMI_pig", metadata_file = "ann/all_five_species_metafile_wrangled.csv" , species = "pig")
wrangled_mat <- wrangle_matrix(path_to_mat = "matrix/10x/aqhumor_UMI_human", metadata_file = "ann/all_five_species_metafile_wrangled.csv" , species = "human")
wrangled_mat <- wrangle_matrix(path_to_mat = "matrix/10x/aqhumor_UMI_macF", metadata_file = "ann/all_five_species_metafile_wrangled.csv" , species = "macF")
wrangled_mat <- wrangle_matrix(path_to_mat = "matrix/10x/aqhumor_UMI_macM", metadata_file = "ann/all_five_species_metafile_wrangled.csv" , species = "macM")
