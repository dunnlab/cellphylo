...
We recommend running this on a cluster using multiple CPUs.
...
We will calculate total tree length (sum of all branch lengths), the sum of interior edge lengths, sum of tip edge lengths, and star-ness score (ratio of tip to interior edge lengts).
