...
We will restrict our following analyses to this 540 cel subset of the 919 cell 20 PC matrix (Fig. S1, step C1.1).

# Infer averaged focal tree and calculate Jumble scores
...
We first take the 919 cell 20 PC matrix (Fig. S1, step C2.1) and average each of its ten replicates, selecting the 54 cell type groups in our permissible cells list. This creates a 54 averaged-cell 20 PC matrix (Fig. S1, step D1.2)
...
Infer the jumble trees from the infile for the 54 averaged-cell 20 PC matrix (Fig. S1, step D1.2) (ie from `contml_54means_20PC_afterPCA_mtx`).
