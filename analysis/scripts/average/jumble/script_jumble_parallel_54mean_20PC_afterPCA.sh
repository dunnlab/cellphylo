...
#make file names
outfile_new="outfile_54mean_20PC_afterPCA_jumble_search_${random_seed}"
outtree_new="outtree_54mean_20PC_afterPCA_jumble_search_${random_seed}"
echo ${outfile_new}
echo ${outtree_new}
...
mv ${outtree_new} outtrees_54mean_20PC_afterPCA_jumble_search/${outtree_new}.tre
mv ${outfile_new} outfiles_54mean_20PC_afterPCA_jumble_search/${outfile_new}.txt
