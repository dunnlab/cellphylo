...
#"within-species" is the directory of matrices to quantify cell type group replicates. It expects matrices in 10x feature-barcode format and cell ids in cellphylo format.
...
*To facilitate reproducibilty, we have provided this matrix in `matrix/cross-species_integration/aqhumor_cross_species_integrated_mtx`*

# Create matricecs for tree inference  

## Create 92 cell matrix (Fig. S1, step C1.1)
...
*Because sampling is random, we have provided the 92 cell matrix and list of sampled cells we used in our analysis:`tree_inference/92_cell_tree/contml_92cell_subset_pca_var_norm_20PC_mtx/`*.
...
## Create 54 cell matrix (Fig. S1, step C1.2)
...
*We have provided the matrix in tree_inference/54_cell_tree/contml_54cell_subset_pca_var_norm_20PC_mtx`*.
